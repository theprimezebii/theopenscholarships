...
const editorStyles = `
  ...
  .ProseMirror h1 { font-size: 2.5rem !important; font-weight: 700 !important; margin: 1.5rem 0 1rem !important; }
  .ProseMirror h2 { font-size: 2rem !important; font-weight: 600 !important; margin: 1.25rem 0 0.75rem !important; }
  .ProseMirror h3 { font-size: 1.5rem !important; font-weight: 600 !important; margin: 1rem 0 0.5rem !important; }
  .ProseMirror ul { list-style-type: disc !important; padding-left: 2rem !important; margin: 0.75rem 0 !important; }
  .ProseMirror ol { list-style-type: decimal !important; padding-left: 2rem !important; margin: 0.75rem 0 !important; }
  .ProseMirror li { margin-bottom: 0.25rem !important; }
  .ProseMirror li p { margin: 0 !important; display: inline; }
  .ProseMirror p { margin-bottom: 1rem !important; line-height: 1.6 !important; }
  .ProseMirror img { max-width: 100%; height: auto; border-radius: 0.5rem; margin: 1rem 0; cursor: pointer; }
  .ProseMirror blockquote { border-left: 4px solid #D4A373; padding-left: 1rem; margin: 1rem 0; color: #4a4a4a; font-style: italic; }
  .ProseMirror pre { background: #f5f5f5; padding: 0.75rem; border-radius: 0.5rem; overflow-x: auto; }
  .ProseMirror code { background: #f5f5f5; padding: 0.2rem 0.4rem; border-radius: 0.25rem; font-size: 0.9em; }
  .ProseMirror a { color: #0B3B2F; text-decoration: underline; cursor: pointer; }
  .ProseMirror a:hover { color: #D4A373; }
