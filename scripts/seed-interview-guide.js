...
<div><h3>Chevening Scholarship Interview</h3><p><strong>Q: How will you use your UK degree to make a difference in your home country?</strong><br/>"I plan to establish a mentorship program for 100 underprivileged students in my hometown. My UK degree in Education Policy will give me the framework to create an effective curriculum that addresses local needs."</p></div>
<div><h3>DAAD Scholarship Interview</h3><p><strong>Q: Why Germany and why this specific program?</strong><br/>"Germany is a leader in renewable energy, and TU Berlin's program specifically focuses on solar technology - the exact field I want to work in. Professor Schmidt's research on photovoltaic efficiency directly aligns with my goal of bringing affordable solar solutions to my community."</p></div>
<div><h3>Fulbright Interview</h3><p><strong>Q: How will you promote cultural exchange?</strong><br/>"I plan to organize weekly cultural events on campus where international and American students can share traditions, food, and perspectives. I also want to start a blog documenting my experience to inspire others from my country to apply."</p></div>
...
async function seed() {
  try {
    ...
    if (result.upsertedCount > 0) {
      ...
      console.log(`Already up to date: ${post.slug}`);
    }
