    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 flex items-center justify-center py-12">
        <div className="bg-white rounded-xl border border-gray-200 p-8 max-w-md w-full">
          <h1 className="font-serif text-2xl text-[#1A1A1A] mb-6 text-center">Create Account</h1>
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            Already have an account? <Link href="/auth/signin" className="text-[#0B3B2F] hover:underline">Sign In</Link>
          </p>
        </div>
      </main>
      <Footer />
